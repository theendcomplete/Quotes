...
//        if (Environment.current == Environment.DEVELOPMENT) {
        if ((!User.findByUsername("admin"))) {
            ...
            System.out.println("Preparing default data")
            ...
            Quote quote9 = new Quote(text: "Life is a box of chocolates. You never know what you’re gonna get.", author: "Forrest Gump (character)", rating: 13, user: admin).save(flush: true)
            Quote quote10 = new Quote(text: "Life is riding a bicycle. To keep your balance, you must keep moving.", author: "Albert Einstein", rating: -14, user: admin).save(flush: true)
            ...
            System.out.println("Preparing finished, starting app")
        } else {
